...
define([
    ...
    $.widget('magestore.GoogleMap', {
        ...
        loadStore: function (params, isFilter) {
            ...
            var curentPage = typeof(params.curPage) != "undefined" ? params.curPage : 1;


            if (typeof(params.radius) != "undefined" && typeof(params.latitude) != "undefined" && typeof(params.longitude) != "undefined"){
                var newParams = "radius="+params.radius+"&latitude="+params.latitude+"&longitude="+params.longitude+"&curPage="+curentPage;
            }else{
                var newParams = "curPage="+curentPage;
            }
            ...
            $.ajax({
                ...
                if (data.storesjson) {
                    ...
                    $.each(self.stores, function (index, store) {
                        store.index = index;
                        store.product_name = data.product_name;
                        store.product_url = data.product_url;
