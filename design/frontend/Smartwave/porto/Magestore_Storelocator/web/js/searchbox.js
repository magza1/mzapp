...
define([
    ...
    $.widget('magestore.searchbox', {
            ...
            if(self.$inputAddress.val()) {
                ...
                geocoder.geocode({
                    ...
                    if (status === google.maps.GeocoderStatus.OK) {
                        ...
                        $.cookie('cookie_current_possition', self.$inputAddress.val() , { expires: 7 });
                    }
                });
            }
        },
        ...
        getRadius: function () {
            ...
            var distanceUnit = options.distanceUnit ? options.distanceUnit : "Km";
            if(options.storageUnit[distanceUnit]) {
                factor = options.storageUnit[distanceUnit].factor;
            } else {
