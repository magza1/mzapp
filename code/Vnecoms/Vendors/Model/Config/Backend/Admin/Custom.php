 ...
 */
namespace Vnecoms\Vendors\Model\Config\Backend\Admin;
...
class Custom extends \Magento\Framework\App\Config\Value
{
     ...
     */
    public static function getVendorStoreId(){
        $om = \Magento\Framework\App\ObjectManager::getInstance();
        $manager = $om->create('Magento\Store\Model\StoreManagerInterface');
        $store = $manager->getStore('vendors');
        return $store->getId();
    }
}
