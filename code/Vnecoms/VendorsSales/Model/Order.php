...
class Order extends \Magento\Framework\Model\AbstractModel
{
     ...
     * Get Item COllection
     *
     * @return Ambigous <\Magento\Sales\Model\ResourceModel\Order\Item\Collection, \Magento\Sales\Model\ResourceModel\Order\Collection\$this, \Magento\Sales\Model\ResourceModel\Order\Item\Collection>
     */
/*     public function getItemsCollection(){
        $itemCollection = $this->getOrder()->getItemsCollection();
        $itemCollection->addAttributeToFilter('entity_id',array('in' => array_keys($this->getAllItems())));
