    ...
    protected function _prepareForm()
    {
        ...
        if ($model->getId()) {
            ...
            $fieldset->addField(
                'license_key',
                'label',
                ['name' => 'license_key', 'label' => __('License Key'), 'title' => __('License Key'), 'required' => true]
            );
            ...
            if(!$data['secure_key']){
                ...
                $notes[] = '<span class="admin__field-error" style="margin-top: 10px;">'.__('Your secure key is different with the registered secure key. The related extension(s) will not be acitvated. Please contact us if you want to change your secure key').'</span>';
            }
            $fieldset->addField(
                'secure_key',
                'label',
            ...
            $fieldset->addField(
                ...
                [
                    ...
                    'required' => true, 
                    'note' => __("Enter the license key which you got when you purchase an extension from www.vnecoms.com.")
                ]
            );
        }
