...
namespace Magestore\Storelocator\Model\ResourceModel\Store\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Magestore\Storelocator\Model\ResourceModel\Store\Collection as StoreCollection;
...
class Collection extends StoreCollection  implements SearchResultInterface
{
    ...
    {
		$level = 'store';
        $this->_logger->log($level,'errorlog1234', $this->getConnection()->fetchCol($this->_getAllIdsSelect($limit, $offset), $this->_bindParams)); 
