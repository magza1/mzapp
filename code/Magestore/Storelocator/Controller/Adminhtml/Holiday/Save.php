...
namespace Magestore\Storelocator\Controller\Adminhtml\Holiday;
 ...
 */
class Save extends \Magestore\Storelocator\Controller\Adminhtml\Holiday
{
    /**
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            /** @var \Magestore\Storelocator\Model\Holiday $model */
